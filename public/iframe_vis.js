define(function(require) {
  ...
  require('plugins/iframe_vis/iframe_vis.less');

  // we also need to load the controller and used by the template
  require('plugins/iframe_vis/iframe_vis_controller');
  ...
  function IframeVisProvider(Private) {
    ...
    return new TemplateVisType({
      ...
      template: require('plugins/iframe_vis/iframe_vis.html'),
      params: {
        editor: require('plugins/iframe_vis/iframe_vis_params.html')
      },
